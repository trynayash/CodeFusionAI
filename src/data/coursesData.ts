...
export const coursesData: Course[] = [
  {
    ...
    description: 'Build beautiful, responsive web pages from scratch using semantic HTML5 and modern CSS3.',
    level: 'Beginner',
    duration: '4 weeks',
    students: 22000,
    rating: 4.8,
    ...
    instructorImage: 'https://images.unsplash.com/photo-1544723795-3fb6469f5b39?w=150&h=150&fit=crop&crop=face',
    curriculum: [
      { module: 'Getting Started', lessons: [
        { title: 'Web Basics', url: 'https://www.geeksforgeeks.org/web-development/', videoUrl: 'https://www.youtube.com/watch?v=UB1O30fR-EE' },
        { title: 'Tools Setup', url: 'https://www.geeksforgeeks.org/css-introduction/', videoUrl: 'https://www.youtube.com/watch?v=yfoY53QXEnI' },
        { title: 'Project Structure', url: 'https://www.geeksforgeeks.org/html-tutorial/', videoUrl: 'https://www.youtube.com/watch?v=pQN-pnXPaVg' },
      ], duration: '1 week' },
      { module: 'HTML Core', lessons: [
        { title: 'Semantic Tags', url: 'https://www.geeksforgeeks.org/html5-semantic-elements/', videoUrl: 'https://www.youtube.com/watch?v=Zftx68K-1D4' },
        { title: 'Forms', url: 'https://www.geeksforgeeks.org/html-forms/', videoUrl: 'https://www.youtube.com/watch?v=fNcJuPIZ2WE' },
        { title: 'Media', url: 'https://www.geeksforgeeks.org/html5-video/', videoUrl: 'https://www.youtube.com/watch?v=Qc0Wl0ykUvc' },
      ], duration: '1 week' },
      { module: 'CSS Fundamentals', lessons: [
        { title: 'Selectors', url: 'https://www.geeksforgeeks.org/css-selectors/', videoUrl: 'https://www.youtube.com/watch?v=1PnVor36_40' },
        { title: 'Box Model', url: 'https://www.geeksforgeeks.org/css-box-model/', videoUrl: 'https://www.youtube.com/watch?v=rIO5326FgPE' },
        { title: 'Typography', url: 'https://www.geeksforgeeks.org/css-fonts/', videoUrl: 'https://www.youtube.com/watch?v=OEV8gMkCHXQ' },
        { title: 'Colors', url: 'https://www.geeksforgeeks.org/css-colors/', videoUrl: 'https://www.youtube.com/watch?v=sqJ6xZ9mUwE' },
      ], duration: '1 week' },
      { module: 'Layouts', lessons: [
        { title: 'Flexbox', url: 'https://www.geeksforgeeks.org/css-flexbox/', videoUrl: 'https://www.youtube.com/watch?v=JJSoEo8JSnc' },
        { title: 'Grid', url: 'https://www.geeksforgeeks.org/css-grid-layout/', videoUrl: 'https://www.youtube.com/watch?v=EFafSYg-PkI' },
        { title: 'Responsive Patterns', url: 'https://www.geeksforgeeks.org/responsive-web-design/', videoUrl: 'https://www.youtube.com/watch?v=VQraviuwbzU' },
      ], duration: '1 week' },
    ],
    ...
    whatYouWillLearn: [
      ...
      'Launch a simple portfolio site',
    ],
  ...
  },
  {
    ...
    description: 'Learn core JavaScript concepts to make your web pages dynamic and interactive.',
    level: 'Beginner',
    duration: '5 weeks',
    students: 18500,
    rating: 4.7,
    price: 0,
    image: '🟨',
    skills: ['Variables', 'Functions', 'DOM', 'Events', 'Fetch API'],
    featured: true,
    instructor: 'Rahul Gupta',
    instructorImage: 'https://images.unsplash.com/photo-1552055568-9b56f4c1f38e?w=150&h=150&fit=crop&crop=face',
    curriculum: [
      { module: 'JS Basics', lessons: [
        { title: 'Syntax', url: 'https://www.geeksforgeeks.org/javascript/', videoUrl: 'https://www.youtube.com/watch?v=W6NZfCO5SIk' },
        { title: 'Variables', url: 'https://www.geeksforgeeks.org/javascript-variables/', videoUrl: 'https://www.youtube.com/watch?v=9WIJQDvt4Us' },
        { title: 'Data Types', url: 'https://www.geeksforgeeks.org/javascript-data-types/', videoUrl: 'https://www.youtube.com/watch?v=F3odgpghXzY' },
      ], duration: '1 week' },
      { module: 'Control Flow', lessons: [
        { title: 'Conditions', url: 'https://www.geeksforgeeks.org/javascript-if-else/', videoUrl: 'https://www.youtube.com/watch?v=IsG4Xd6LlsM' },
        { title: 'Loops', url: 'https://www.geeksforgeeks.org/javascript-loops/', videoUrl: 'https://www.youtube.com/watch?v=s9wW2PpJsmQ' },
        { title: 'Functions', url: 'https://www.geeksforgeeks.org/javascript-functions/', videoUrl: 'https://www.youtube.com/watch?v=N8ap4k_1QEQ' },
      ], duration: '1 week' },
      { module: 'DOM & Events', lessons: [
        { title: 'Selecting Elements', url: 'https://www.geeksforgeeks.org/dom-document-object-model/', videoUrl: 'https://www.youtube.com/watch?v=5fb2aPlgoys' },
        { title: 'Events', url: 'https://www.geeksforgeeks.org/javascript-events/', videoUrl: 'https://www.youtube.com/watch?v=XF1_MlZ5l6M' },
        { title: 'Manipulation', url: 'https://www.geeksforgeeks.org/dom-manipulation/', videoUrl: 'https://www.youtube.com/watch?v=wiozYyXQEVk' },
      ], duration: '2 weeks' },
      { module: 'APIs', lessons: [
        { title: 'JSON', url: 'https://www.geeksforgeeks.org/javascript-json/', videoUrl: 'https://www.youtube.com/watch?v=iiADhChRriM' },
        { title: 'Fetch', url: 'https://www.geeksforgeeks.org/javascript-fetch-api/', videoUrl: 'https://www.youtube.com/watch?v=cuEtnrL9-H0' },
        { title: 'Async/Await', url: 'https://www.geeksforgeeks.org/async-await-in-javascript/', videoUrl: 'https://www.youtube.com/watch?v=V_Kr9OSfDeU' },
      ], duration: '1 week' },
    ],
    prerequisites: ['HTML & CSS basics recommended'],
    whatYouWillLearn: [
