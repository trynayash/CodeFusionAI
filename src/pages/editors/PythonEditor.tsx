...
const pythonTemplate = `# Python Online Compiler - CodeFusion AI
...
export default function PythonEditor() {
  ...
  const [title, setTitle] = useState('Python Project');
    ...
    if (currentSnippetId) {
      ...
      if (error) {
        ...
        toast({
          ...
          description: "Your Python code has been updated successfully.",
        });
        loadSnippets();
      }
    } else {
      ...
      if (error) {
        ...
        toast({
          title: "Snippet saved",
          description: "Your Python code has been saved successfully.",
        });
        loadSnippets();
      }
    }
  ...
  const runCode = useCallback(async () => {
    ...
    terminal.addLine(`🐍 Starting Python execution...`, 'info');
    ...
    try {
      ...
      if (result.success) {
        terminal.addLine(`✅ Python execution completed successfully`, 'success');
        ...
        terminal.addLine(`❌ Python execution failed`, 'error');
      ...
      setOutput(`Runtime Error:\n${errorMsg}\n\nThis error occurred during Python execution.`);
      setActiveTab('terminal');
      
      toast({
        title: "Runtime Error",
        description: `Python execution failed: ${errorMsg}`,
        variant: "destructive",
      });
    } finally {
      setIsRunning(false);
      terminal.setRunning(false);
      terminal.addLine(`🏁 Python execution finished`, 'info');
    }
  ...
  const deleteSnippet = async (snippetId: string) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: "Python code snippet has been deleted successfully.",
      });
      loadSnippets();
            ...
            <div className="flex items-center space-x-4 flex-wrap gap-2 min-w-0 flex-1">
              <div className="flex items-center space-x-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">Professional Python IDE</p>
                </div>
              </div>
              ...
              <div className="flex-1 max-w-md">
                <Input
                  ...
                  placeholder="Enter Python project name..."
                />
              </div>
            </div>
            ...
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200">Python History</h3>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Your saved Python projects</p>
                  </div>
                  <Button
                    variant="ghost"
                    size="sm"
                  ...
                  <div className="space-y-3">
                    {snippets.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">No saved Python projects yet</p>
                              ...
                              <div className="flex-1 min-w-0" onClick={() => loadSnippet(snippet)}>
                                <div className="flex items-center space-x-3 mb-2">
                                  ...
                                  <div className="min-w-0 flex-1">
                                    ...
                                    <p className="text-sm text-slate-500 dark:text-slate-400">Python</p>
                                  </div>
                                </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50">
              <div className="flex items-center space-x-4 w-full sm:w-auto mb-3 sm:mb-0">
                <div className="flex items-center space-x-2 bg-blue-50 dark:bg-blue-900/20 px-3 py-2 rounded-lg">
                  <img src={pythonIcon} alt="Python" className="w-5 h-5" />
                  <span className="font-medium text-blue-700 dark:text-blue-300">Python 3.11</span>
                </div>
              </div>
                  ...
                  <div className="space-y-4">
                    {output ? (
                      <motion.div
                        ...
                        <div className={`flex items-center gap-3 mb-4 pb-3 border-b ${
                          ...
                          <span className="font-bold text-sm">
                            {output.includes('Error') ? 'Python Execution Failed' : 'Python Execution Successful'}
                          </span>
                          {executionResult && (
                      ...
                      <div className="text-center py-12">
                        ...
                        <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Ready to Execute Python</h3>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Click "Run Python Code" to see your output here</p>
                        <div className="bg-slate-50 dark:bg-slate-800/50 rounded-lg p-4 max-w-sm mx-auto">
                          <p className="text-xs font-semibold text-slate-600 dark:text-slate-300 mb-2">🐍 Python Tips:</p>
                          <div className="text-xs text-slate-500 dark:text-slate-400 space-y-1 text-left">
                            <p>• Use print() to display output</p>
                            <p>• Check your indentation carefully</p>
                            <p>• Import modules at the top</p>
