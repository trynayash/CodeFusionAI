...
import { X, Mail, ArrowLeft, CheckCircle, AlertCircle, Send } from 'lucide-react';
...
export function MagicLinkModal({ isOpen, onClose }: MagicLinkModalProps) {
  ...
  const { register, handleSubmit, formState: { errors }, reset, watch } = useForm<MagicLinkForm>();
              ...
              <>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  <div className="space-y-2">
                    <Label htmlFor="magic-email" className="text-slate-700 dark:text-slate-300 font-medium flex items-center gap-2">
